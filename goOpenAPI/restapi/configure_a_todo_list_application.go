...
import (
	...
	"github.com/lukekhamilton/goAdventures/goOpenAPI/restapi/operations"
	"github.com/lukekhamilton/goAdventures/goOpenAPI/restapi/operations/todos"
)

//go:generate swagger generate server --target ../../goOpenAPI --name ATodoListApplication --spec ../swagger.yml
